...
**Arash Nikzad**<sup>1</sup>, **Sasan Sarbishegi**, **Ali Dasmeh**<sup>2</sup>, **Muhammad Asif**<sup>3</sup>, **Parsa Gharavi**<sup>1</sup>, **Erik Husom**<sup>4</sup>, **Sagar Sen**<sup>4</sup>, **Andrew B. Lehr**<sup>5,6,7</sup>, **Olivier Penacchio**<sup>8</sup>, **Ana Clemente**<sup>3</sup>, **Tristan M. Stöber**<sup>6,7,9</sup>  
...
We resolve this by reimplementing CSCG as a single differentiable, gradient-trained computation [11] in TensorFlow — a model we call **gradCSCG**. This innovation allows us to co-train gradCSCG with a vector-quantized variational autoencoder (VQ-VAE). We demonstrate that this approach preserves CSCG's expressivity while enabling it to handle sensory variability and complexity in environments composed of MNIST digits.
...
The foundation of this work is the Clone-Structured Causal Graph (CSCG) algorithm  [9, 10]. Here we relate our pipeline to efforts to *learn* cognitive maps and, in particular, to couple them with neural networks.
